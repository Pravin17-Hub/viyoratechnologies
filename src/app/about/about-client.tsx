...
export default function AboutPage() {
  return (
    <PageWrapper>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.25 }}
            ...
            A group of creative builders pushing the boundaries of web development, custom UI, and modern design — one project at a time.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="flex flex-col gap-5">
              {[
                { icon: <Target className="w-5 h-5" />, color: "#fbbf24", title: "Our Mission", text: "To design and develop clean, high-performance digital products while giving students real engineering experience that no classroom can provide." },
                { icon: <Eye className="w-5 h-5" />,    color: "#701a75", title: "Our Vision",  text: "To become an elite student-led studio known globally for delivering industry-grade visual design and engineering quality — without the corporate price tag." },
              ].map(item => (
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
              ...
              <p className="text-amber-500 text-xs font-bold uppercase tracking-widest">Our Background</p>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                Viyora Technologies started with a shared vision among student builders. We realized that theory was only half the journey — the real magic happens when you build actual products for actual people.
              </p>
              <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                We specialize in sleek responsive websites, multi-device landing pages, SaaS MVPs, and customized boutique client pages. Everything ships with high visual standards, smooth transitions, and clean code.
              </p>
              <Link href="/contact">
      ...
      <section className="py-24 relative z-10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <p className="text-amber-500 text-xs font-bold uppercase tracking-widest mb-3">Core Principles</p>
      ...
      {/* ══ TIMELINE ══ */}
      <section className="py-24 relative z-10 border-t" style={{ borderColor: "var(--border-subtle)" }}>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <p className="text-amber-500 text-xs font-bold uppercase tracking-widest mb-3">Our Journey</p>
      ...
      {/* ══ TEAM ══ */}
      <section className="py-24 relative z-10 overflow-hidden border-t" style={{ borderColor: "var(--border-subtle)" }}>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-[150px] pointer-events-none"
          style={{ background: `rgba(217,119,6,calc(var(--orb-opacity)*0.3))` }} />
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <p className="text-amber-500 text-xs font-bold uppercase tracking-widest mb-3">Our Team</p>
          ...
          <div className="max-w-3xl mx-auto text-center" style={{ color: "var(--text-secondary)" }}>
            <p className="text-base leading-relaxed mb-6">
              We are a close-knit collective of student builders, designers, and hobbyists. By combining our academic learning with real-world product development, we design and build premium web applications, SaaS MVPs, and customized client portals.
            </p>
      ...
      <section className="py-24 relative z-10 text-center overflow-hidden border-t" style={{ borderColor: "var(--border-subtle)" }}>
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[500px] h-[500px] rounded-full blur-[120px] animate-pulse-glow" style={{ background: `rgba(217,119,6,var(--orb-opacity))` }} />
        </div>
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, type: "spring" }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact">
                <button className="group px-8 py-4 rounded-2xl font-bold text-black text-sm bg-gradient-to-r from-yellow-500 to-amber-500 shadow-xl shadow-amber-500/30 hover:shadow-amber-500/50 hover:scale-105 active:scale-95 transition-all duration-300">
              ...
              <Link href="/careers">
                <button className="px-8 py-4 rounded-2xl font-bold text-sm border hover:border-amber-500/40 active:scale-95 transition-all duration-300"
