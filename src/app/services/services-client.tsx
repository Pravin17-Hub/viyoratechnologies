...
const pipelineFlows: Record<string, { name: string; icon: React.ReactNode }[]> = {
  "ai-solutions": [
    ...
    { name: "AI Core API",   icon: <Cpu className="w-4 h-4" /> },
    { name: "Vector Index",    icon: <Database className="w-4 h-4" /> },
    { name: "Output Hub",  icon: <Server className="w-4 h-4" /> },
  ],
  "web-dev": [
    { name: "Edge Router", icon: <Server className="w-4 h-4" /> },
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
            ...
            Bespoke pages, premium applications, and custom design layouts built to bring your digital ideas to life.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-24 relative z-10 overflow-hidden border-t" style={{ borderColor: "var(--border-subtle)" }}>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <p className="text-amber-500 text-xs font-bold uppercase tracking-widest mb-3">Interactive Flow</p>
